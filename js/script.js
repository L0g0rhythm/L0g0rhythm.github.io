...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (tabs.length > 0 && contents.length > 0) {
    ...
    // Fallback: if no tab has active-tab class in HTML, activate the first one
  ...
  // Removed applyStaggeredAnimation helper function
  ...
  // Removed loadSkills function definition

  loadProjects();
  loadServices();
  loadSocialLinks();
  loadAboutMe();
  // Removed loadSkills call
});
